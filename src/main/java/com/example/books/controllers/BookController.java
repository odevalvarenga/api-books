...
import com.example.books.config.ApiError;
...
public class BookController {
    ...
    @Parameter(
            ...
            description = "Chave única para evitar requisições duplicadas",
            required = true,
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(
                    responseCode = "409",
                    description = "Conflito: livro possui registros vinculados"
            ),
